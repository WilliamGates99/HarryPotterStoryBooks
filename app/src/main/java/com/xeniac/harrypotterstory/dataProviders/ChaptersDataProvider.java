...
public class ChaptersDataProvider {
    ...
    static {
        ...
        //Chapter 3 has 18 pages but the free version contains only 10 pages.
        addItem(new DataItemChapters(23, 3, R.string.string_book_2_chapters_title_3, 10, 0, 0, 2, "ic_cover_chapters_2_3.jpg", false, true));
        ...
        addItem(new DataItemChapters(532, 32, R.string.string_book_5_chapters_title_32, 22, 0, 0, 5, "ic_cover_chapters_5_32.jpg", false, false));
        addItem(new DataItemChapters(533, 34, R.string.string_book_5_chapters_title_33, 13, 0, 0, 5, "ic_cover_chapters_5_33.jpg", false, false));
        addItem(new DataItemChapters(534, 33, R.string.string_book_5_chapters_title_34, 17, 0, 0, 5, "ic_cover_chapters_5_34.jpg", false, false));
